...
export default function HomeClient() {
  ...
  const renderSection = (sectionId: string) => {
    switch (sectionId) {
      case 'hero':
        return (
          <section className="hero-section" id="home" key="hero">
      ...
      case 'services':
        return (
          <section id="services" className="section" style={{ backgroundColor: 'var(--background)' }} key="services">
      ...
      case 'gallery':
        return (
          <section id="gallery" className="section" style={{ backgroundColor: 'var(--surface)' }} key="gallery">
            <div className="container">
              <motion.h2 
                className="section-title"
                initial={{ opacity: 0, y: 20 }}
      ...
      case 'quote':
        return (
          <section className="quote-banner" key="quote">
            <div className="container">
              <motion.div
      ...
      case 'image_banner':
        return (
          <section className="image-banner" key="image_banner">
            <div className="image-banner-bg" />
          </section>
        );
      case 'team':
        return (
          <section id="team" className="section" style={{ backgroundColor: 'var(--background)' }} key="team">
            <div className="container">
              <motion.h2 
                className="section-title"
                initial={{ opacity: 0, y: 20 }}
      ...
      case 'article':
        return (
          <section id="article" className="section article-section" style={{ backgroundColor: 'var(--surface)' }} key="article">
  ...
  return (
    <main>
      ...
      {layout.filter(item => item.visible).map(item => renderSection(item.id))}
