...
db.pragma('busy_timeout = 10000'); // Wait up to 10 seconds for locks to resolve


// Initialize the table if it doesn't exist
// Run migrations and seeds inside an immediate transaction to handle Next.js build-time workers
db.transaction(() => {
  // Initialize the table if it doesn't exist
  db.exec(`
